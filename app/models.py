...
class Document(db.Model):
    ...
    received_by           = db.Column(db.String(150), nullable=True, index=True)
    current_department_id = db.Column(db.Integer, db.ForeignKey('departments.department_id'), nullable=True, index=True)
...
class Transaction(db.Model):
    ...
    document_id      = db.Column(db.Integer, db.ForeignKey('documents.document_id'), nullable=False, index=True)
    department_id    = db.Column(db.Integer, db.ForeignKey('departments.department_id'), nullable=True)
